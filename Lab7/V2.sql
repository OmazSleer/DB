...
/*
		¬ывести значени€ полей [ProductID], [Name], [ProductNumber] из таблицы 
		[Production].[Product] в виде xml, сохраненного в переменную. ‘ормат 
...
GO
/*
		—оздать хранимую процедуру, возвращающую таблицу, заполненную из xml 
		переменной представленного вида. ¬ызвать эту процедуру дл€ заполненной 
